    ...
    html`
      <div class="splash">
        <div class="container">
          <a
            target="_blank"
            href="https://github.com/sw-yx/netlify-plugin-search-index"
            >Github code here</a
          >
          <h1 class="main-title">Netlify search plugin demo</h1>
          <p>
            This search bar does not rely on any external service. It queries a
            JSON search index generated at build time, from a Netlify function.
            Also it's lightweight, it automatically parses your content and
            implements
            <a href="https://fusejs.io/" target="_blank">FuseJS</a> weighted
            search 👏
          </p>
      ...
      <div class="grid results">
        ${searchState.results.length
          ? html`<p style="margin-bottom: 24px">
              ${searchState.results.length} articles found
            </p>`
          : ""}
