...
var task = require('core-js/modules/_task').set;
var microtask = require('core-js/modules/_microtask')();
var newPromiseCapabilityModule = require('core-js/modules/_new-promise-capability');
...
var USE_NATIVE = !!function () {
  try {
    ...
    var FakePromise = (promise.constructor = {})[require('core-js/modules/_wks')('species')] = function (exec) {
      exec(empty, empty);
    };
