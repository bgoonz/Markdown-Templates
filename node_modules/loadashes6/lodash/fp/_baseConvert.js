const mapping = require('./_mapping'), fallbackHolder = require('./placeholder');
...
function baseArity(func, n) {
  return n == 2
    ? function(a, b) { return func(...arguments); }
    : function(a) { return func(...arguments); };
}
...
function baseConvert(util, name, func, options) {
  ...
  function wrap(name, func, placeholder) {
    ...
    if (result == func) {
      result = forceCurry ? curry(result, 1) : function(...args) {
